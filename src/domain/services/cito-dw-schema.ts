  ...
  tables: [
    {
      ...
      columns: [
        ...
        { name: 'upper_threshold_absolute', type: 'float', nullable: false },
        { name: 'lower_threshold_absolute', type: 'float', nullable: false },
        { name: 'upper_threshold_relative', type: 'float', nullable: false },
        { name: 'lower_threshold_relative', type: 'float', nullable: false },
