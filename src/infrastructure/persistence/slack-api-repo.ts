    ...
    blocks.push({
      ...
      elements: [
        ...
        },
        {
          type: 'button',
          style: 'primary',
          url: `${appConfig.slack.buttonBaseUrl}?alertId=${msgConfig.alertId}&testType=${msgConfig.testType}&testSuiteId=${msgConfig.testSuiteId}&importance=${msgConfig.importance}&boundIntervalRelative=${msgConfig.boundIntervalRelative}&userFeedbackIsAnomaly=0`,
          text: {
            type: 'plain_text',
            text: 'Mark as Normal',
          },
